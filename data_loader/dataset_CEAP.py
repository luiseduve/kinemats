...
class DatasetCEAP():
    ...
    def load_or_create_index(self):
        ...
        video_info_dict = utils.load_json(video_info_path)
        ...
        with os.scandir(demographics_path) as iterator:
            for entry in iterator:
                ...
                if( not entry.name.startswith(".") and 
                    ...
                    data_participant_dict = utils.load_json(participant_data_filename)["QuestionnaireData"][0] # Unpack dict
        ...
        utils.create_json(files_index, self.index_file_path, pretty=True)
    ...
    def _load_json_data_from_filepath(self, path_to_requested_file):
        ...
        data_participant_dict = utils.load_json(path_to_requested_file)
